                ...
                <Row className="dolar-info">
                    ...
                    >
                        ...
                        <p>
                            ...
                            importação/exportação, o dolár comercial se refere
                            às transações comerciais entre grandes empresas e
                            instituições financeiras.
                        </p>
                        <p>
                            O dolár comercial possui cotação variável (confira
                            no gráfico) que é negociada entre bancos e empresas
                            sob interferência do Banco Central do Brasil; que
                            visa evitar a subida ou a descida excessiva da taxa
                            de câmbio, evitando a desvalorização do real e
                            minimizando os efeitos sobre as exportações,
                            mantendo um valor viável para balança comercial
                            brasileira.
                        </p>
                        <h3>Dólar Ptax</h3>
                        <p>
                    ...
                    <Col className="dolarturismo-info" lg={6}>
                        <h2>Dolar Turismo</h2>
                        <p>
                            Utilizado por pessoas físicas em viagens ao exterior
                            e para a compra de bens e serviços em sites
                            internacionais.
                        </p>
                        <p>
                            ...
                            segurança e transporte da moeda até as casas de
                            câmbio.
                        </p>
                    ...
                    <Col className="sobreodolar-info" lg={6}>
                        <h2>Sobre o Dólar</h2>
                        <p>
